...
import type { VulnmapTarget, SyncTargetsConfig } from '../../lib/types';
...
const debug = debugLib('vulnmap:sync-org-projects');
...
export async function updateOrgTargets(
  ...
  const requestManager = new requestsManager({
    userAgentPrefix: 'vulnmap-api-import:sync',
    period: 1000,
    maxRetryCount: 3,
  });
