...
import { GithubOrgData, VulnmapOrgData } from './types';
import { getGithubToken } from './get-github-token';

const debug = debugLib('vulnmap:github');
...
export async function githubOrganizations(): Promise<VulnmapOrgData[]> {
