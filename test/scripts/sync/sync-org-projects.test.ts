...
describe('updateTargets', () => {
  ...
  process.env.VULNMAP_LOG_PATH = './';
  process.env.VULNMAP_TOKEN = 'dummy';
  ...
  describe('Github', () => {
    ...
    it('Removed projects that were accidentally added from `node_modules`', async () => {
      ...
      const projectsAPIResponse: ProjectsResponse = {
        ...
        projects: [
          {
            name: 'vulnmap/monorepo:build.gradle',
          ...
          {
            name: 'vulnmap/monorepo(main):package.json',
          ...
          {
            name: 'vulnmap/monorepo:node_modules/package.json',
      ...
      const importedProjects: Project[] = [
        {
          projectUrl: `https://app.vulnmap.khulnasoft.com/org/hello/project/${projectId}`,
          success: true,
      ...
      const failed: syncProjectsForTarget.ProjectUpdateFailure[] = [
        {
          errorMessage:
            'Failed to update project f57afea5-8fed-41d8-a8fd-d374c0944b07 via Vulnmap API. ERROR: Error',
    ...
    it('updates a projects branch if default branch changed', async () => {
      ...
      const projectsAPIResponse: ProjectsResponse = {
        ...
        projects: [
          ...
          {
            name: 'vulnmap/goof:deactivated/package.json',
            id: 'af137b96-6966-46c1-826b-2e79ac49bbxx',
            created: '2018-10-29T09:50:54.014Z',
            origin: 'github',
            type: 'npm',
      ...
      const targets: VulnmapTarget[] = [
        {
          ...
          id: 'xxx',
          relationships: {} as unknown as VulnmapTargetRelationships,
          type: 'target',
        },
        {
          attributes: {
            displayName: 'vulnmap/bar',
            isPrivate: true,
            origin: 'github',
            remoteUrl: null,
          },
    ...
    it('successfully updated several targets (dryRun mode)', async () => {
      ...
      const projectsAPIResponse1: ProjectsResponse = {
        ...
        projects: [
          ...
          {
            name: 'vulnmap/bar:deleted/package.json',
            id: deletedProjectId,
            created: '2018-10-29T09:50:54.014Z',
            origin: 'github-enterprise',
            type: 'npm',
...
describe('bulkImportTargetFiles', () => {
  ...
  it('succeeds to import a single file', async () => {
    ...
    expect(updated[0]).toMatchObject({
      ...
      from: 'Gemfile.lock',
      projectPublicId: projectId,
      to: `https://app.vulnmap.khulnasoft.com/org/hello/project/${projectId}`,
      type: 'import',
    });
  });
